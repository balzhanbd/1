...
class Snake:
    ...
    def drawingSnake(self):
        ...
        headTexture = pygame.image.load('TSIS10/snake/snakehead.png')
...
font = pygame.font.Font('TSIS10/snake/font.ttf', 25) # imporing our font, from our file
...
wall_texture = pygame.image.load('TSIS10/snake/cobble4040.png')
wall_coordinates = []
pause = pygame.image.load('TSIS10/snake/pause.png')
